...
class compareTo_Test {
	...
	void setUp() throws Exception {
		...
		cars3h = new Car[]{new Car("4 h 3 3 6"), new Car("10 h 3 2 5")};
	...
	@Test
	void testCompareTo() {
		assertEquals(cars2v[1], cars2v[2]);
		
		assertNotEquals(cars2h[0], cars2v[0]);

		assertNotEquals(cars2h[0], cars3h[0]);

		assertNotEquals(cars2v[0], cars2v[1]);
		
		assertNotEquals(cars2h[0], cars2h[1]);
